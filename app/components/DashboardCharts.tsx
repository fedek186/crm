        ...
        <div className="h-[280px] w-full">
          <ResponsiveContainer width="100%" height="100%">
            <ComposedChart data={chartData2} margin={{ top: 20, right: 10, left: -20, bottom: 0 }}>
              ...
              <Legend iconType="circle" wrapperStyle={{ fontSize: '13px', paddingTop: '20px' }} />
              <Area yAxisId="left" type="monotone" dataKey="total_users" name="Usuarios Totales" stroke="#818cf8" fillOpacity={1} fill="url(#colorTotal)" strokeWidth={3} activeDot={{ r: 7, strokeWidth: 0, fill: "#6366f1" }} />
              <Line yAxisId="right" type="monotone" dataKey="active_proportion" name="Activos %" stroke="#10b981" strokeWidth={3} dot={{ r: 4, fill: "#10b981", strokeWidth: 0 }} activeDot={{ r: 7, strokeWidth: 0, fill: "#059669" }} />
            </ComposedChart>
          </ResponsiveContainer>
        </div>
      </div>
