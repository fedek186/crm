    ...
    >
      ...
      <div className="space-y-3">
        ...
        <div className="flex gap-2">
          ...
          <div>
            <span className="text-lux-muted text-[10px] uppercase tracking-widest block mb-0.5 mt-1">Medio</span>
            <span className="text-white text-xs font-medium">{formatMedia(contact.media)}</span>
          </div>
        </div>
